...
class LedgerReader { constructor(refunds) { this.refunds = refunds; } async readRefundState(ref) { return this.refunds[ref] ?? "MISSING"; } }
class InMemoryReceiptStore {
  claims = []; contractVersions = []; authoritativeChecks = []; schedules = []; trusted = new Map();
